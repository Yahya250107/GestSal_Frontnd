...
import { authGuard, managerGuard, rhGuard, employeeGuard } from './Page/services/auth-guard';
...
export const routes: Routes = [
  ...
  { path: 'mon-salaire', component: MonSalaireComponent, canActivate: [authGuard, employeeGuard] },
];